...
# Updated Headers from your new request
HEADERS = {
    'authority': 'api.asco.org',
    'method': 'POST',
    'path': '/graphql2',
    'scheme': 'https',
    'accept': '*/*',
...
# Updated GraphQL query template (from your new payload - getPersons query)
GRAPHQL_QUERY = """query getPersons($sessionId: String!) {
  __typename
...
def main_sequential():
    ...
    output_file = 'asco_persons_raw_data.json'
    
    print("=" * 60)
    print("ASCO Persons Raw API Data Collection Script (Sequential)")
    print("=" * 60)
...
def main_parallel(max_workers=5):
    ...
    # Output file - raw API data
    output_file = 'asco_persons_raw_data_parallel.json'
    
    print("=" * 60)
    print(f"ASCO Persons Raw API Data Collection Script (Parallel - {max_workers} workers)")
    print("=" * 60)
