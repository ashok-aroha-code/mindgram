...
def collect_session_data(ids_file_path, output_file=None):
    ...
    if output_file is None:
        ...
        output_file = f"aacr_session_data_{timestamp}.json"
    ...
    # Set up the session with headers from the request
    ...
    for index, session_id in enumerate(session_ids, 1):
        ...
        url = f"https://www.abstractsonline.com/oe3/Program/21436/Session/{session_id}/presentations"
